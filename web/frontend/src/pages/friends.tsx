...
export function FriendsPage() {
  ...
  const deleteFriend = async (friend: Friend) => { try { await post(`/friends/${friend.id}/delete`); await audience.reload(); } catch (reason) { setError((reason as Error).message); } };
