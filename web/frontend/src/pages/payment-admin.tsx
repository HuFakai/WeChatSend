...
export function PaymentAdminPage() {
  ...
  return <Page>
    ...
    {error && <ErrorState message={error} />}{notice && <div role="status" className="rounded-xl border border-neutral-300 bg-neutral-50 p-4 text-sm text-neutral-800">{notice}</div>}
